...
void b2Sprite::setTiles(float _tileWidth) 
{
	float _width = getContentSize().width;
	b2Vec2 vertices[4];
	vertices[0].Set(0, -0.87);
	vertices[1].Set(0, 0.87);
	vertices[2].Set(getContentSize().width / 36 , 0.87);
	vertices[3].Set(getContentSize().width / 36 , -0.87);
